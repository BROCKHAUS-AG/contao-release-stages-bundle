...
namespace BrockhausAg\ContaoReleaseStagesBundle\Controller\FrontendModule;
 ...
 *
 * @FrontendModule(FrontendController::TYPE, category="frontend", template="mod_frontend")
 */
class FrontendController extends AbstractFrontendModuleController
{
    public const TYPE = 'frontend';
